...
function FilterBar({resorts, lat, lng, setSort}) {
    const [filters, setFilters] = useState([
        ...
        {
            title:"Fresh Snow",
            titleLong:"fresh snowall total",
            id: 5,
            status: "",
        },
        {
            title:"24 hr Snow",
            titleLong:"total snowfall in 24 hrs",
            id: 6,
            status: "",
        },
        {
            title:"72 hrs Snow",
            titleLong:"total snowfall in 72 hrs",
            id: 7,
            status: "",
        },
        {
            title:"Peak Depth",
            titleLong:"snow depth at mtn. peak",
            id: 8,
            status: "",
        },
        {
            title:"Base Depth",
            titleLong:"snow depth at mtn. base",
            id: 9,
            status: "",
        },
